    ...
    html : function html(clubName) {
        return `
            ...
            <body>
                ...
                <main>
                    <form action="/write/${clubName}/create_process" method="POST" enctype="multipart/form-data">
                        <!-- 게시판 선택 콤보박스 -->
                        ...
                        <div class="form-group">
                            <!-- 게시글 제목 -->
                            <input type="text" placeholder="제목을 입력해 주세요." name="post_title" id="title">
                        </div>
                        <div class="form-group">
                            <!-- 게시글 내용 -->
                            <textarea style="resize: none;" name="post_desc" id="desc" placeholder="내용을 입력해 주세요."></textarea>
                        </div>
